...
#  | |    / _` |_  | | | |______| |/ _ | '__| '_ ` _ \| | | \ \/ /
#  | |___| (_| |/ /| |_| |      | |  __| |  | | | | | | |_| |>  < 
#  \_____/\__,_/___|\__, |      \_/\___|_|  |_| |_| |_|\__,_/_/\_\
#                    __/ |                                        
#                   |___/                                         
                              v 1.0$rset"                                                          
...
echo " "
echo " "
echo -e "$yellow                             ➡$cyan [1️⃣] INSTALL PACKAGES"
echo -e "$yellow                             ➡$cyan [2️⃣] UPDATE SCRIPT"
echo -e "$yellow                             ➡️$cyan [3️⃣] DELETE SCRIPT"
echo -e "$yellow                             ➡$cyan [4️⃣] ABOUT ME"
echo -e "$yellow                             ➡️$cyan [5️⃣] EXIT"
echo " "
echo " "
